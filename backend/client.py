...
class Client:
    def __init__(self):
        self.channel = self.auth_stub = self.chat_stub = None # Grpc stubs
        self.connected = False
        self.username = "" # Current user logged in

    def connect(self, host="localhost", port=50051):
        # Tries to connect the client based on host, port inputs
        ...
        return self.connected # Client's connection status
